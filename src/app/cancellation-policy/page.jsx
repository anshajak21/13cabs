...
export const metadata = {
    title: "13Cabs SydneyCancellation policy | Reliable Taxi Service in Sydney",
    ...
    return (
        <main className="main">
            <div className="container">
                ...
                <p>About our cancellation policy: 13Cabs Sydneyalways strives to provide reliable and timely taxi services. But we can understand that plans may change, and any time a passenger may need to cancel the ride. This cancellation policy gives the terms under which cancellation is handled.</p>
                ...
                <ol>
                    ...
                    <li>For safety purposes, 13Cabs Sydneymay cancel your ride at any time if the driver faces any violation of our terms and conditions. In such cases cancellation fees may apply</li>
                </ol>
                ...
                <p>13Cabs Sydneyhas all the rights to make the changes in cancellation policy at any time. All the changes will be provided to you through our website. Continuation using our services after the changes become applied signifies your acceptance of the new policy.</p>
