...
export const metadata = {
    title: "Apex Maxi TERMS AND CONDITIONS | Reliable Taxi Service in Sydney",
    ...
    return (
        <main className="main">
            <div className="container">
                ...
                <h2>Services</h2>
                <p>Apex Maxi provides services regarding standard taxis, luxurious taxis, airport taxis, maxi cab, and wheel-chair taxis in Sydney, Australia.</p>
                ...
                <p><b>Cancellation policy:</b> Customers can cancel their booking through our website or through calling our customer service. Cancellation fees may be applicable. Apex Maxi has all rights to change fees for delayed cancellations.</p>
                <h2>Payment </h2>
                ...
                <p><b>Indirect Damages:</b> Apex Maxi is not responsible for any indirect, consequential, or incidental damages arising from the use of our services.</p>
                <h2>Privacy and Data Protection</h2>
                <p><b>Collection of Data:</b> Apex Maxi collects some personal information that is necessary for providing our services to customers, including contact details and payment information.</p>
                <p><b>Data use:</b> Customer data is used accordingly with our privacy policy. We can share your information with third parties (Which are helping hands of Apex Maxi in providing the best services for customers). We can share your information as required for service delivery or as mandated by law.</p>
                <h2>Terms Modifications</h2>
                <p>Apex Maxi has all the rights to update these terms from time to time. Any update will be posted on our website and will be applicable immediately upon posting. Continuous use of our services after applying some updates signifies your acceptance of the revised terms.</p>
