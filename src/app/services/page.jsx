    ...
    const comprehensiveTaxi = [
        {
            ...
            'text': "Never take a chance at the end time, book the on time taxi for your Sydney Airport transfers and leave the stress baggage at home. 13cabdsSydney airport transfers have covered you with all comfort and at most reliable price.",
            'link': ''
        },
        {
            ...
            'name': "Baby Seat Taxi",
            'text': "For the utmost safest ride for your family who have a toddler or a new born baby with them. Your first priority should be  the baby seat taxi service Sydney . with 13CabsSydney you can enjoy the ride and travel with all security for your family.",
            'link': ''
        },
        {
            ...
            'text': "It may be so challenging to travel in a wheelchair and with these circumstances travelling is Sydney taxi can be more challenging but with 13CabsSydney it will be at ease. Comfortable ride for disabled persons, book now WheelChair Taxi Sydney.",
            'link': ''
        },
        {
            'img': "/img/cars/canry.webp",
            'name': "Premium Service",
            'text': "Premium taxi service Sydney at the most reliable cost in the city. Ride in Style and comfort. 13CabsSydney premium taxi sydney services  ensures a luxury ride that touches the extra level of elegance at minimum booking fee. Luxury and reliability means 13CabsSydney.",
            'link': ''
        },
        {
            ...
            'name': "Taxi For Pets",
            'text': "Going to a picnic with your family, and having the pet together may create a problem but with 13CabsSydney it’s not a big Deal. Whether its a vet visit or some grooming session, hassle-free pet transport is covered through 13Cabs Sydney by pet taxi Sydney.",
            'link': ''
        },
        {
            'img': "/img/cars/parcel.webp",
            'name': "Parcel Delivery",
            'text': "Delivering some important documents or something fragile to another place. Anything that you can get in 13CabsSydney taxi, we surely deliver door-to-door at the price of a cab fare.  Parcel delivery service Sydney gets your parcel within meantime and delivers it at your selected location.",
            'link': ''
        },
        {
            'img': "/img/cars/canry.webp",
            'name': "Full Size Sedan",
            'text': "Is it a 3-4 people group trip or a business meeting in a car ride. Don’t compromise with the comfort and luxurious service of 13CabsSydney we provide you the reliable service taxi Sydney and with reliable cost. So sit in, relax and enjoy the ride in style.",
            'link': ''
        },
        {
            'img': "/img/cars/kiac.webp",
            'name': "SUVs",
            'text': "Extra space for everything, no worries of luggage and leg space. Our SUVs will be covered for you. Smoothest and comfortable and a perfect ride for maximum seven passengers. Style and comfort are provided by our SUVs taxi Service Sydney.",
            'link': ''
        },
        {
            'img': "/img/cars/11-seater.webp",
            'name': "Maxi-Taxi Sydney Service",
            'text': "A Large group travelling together towards the Sydney Airport. 13CasbSydney can accommodate 11 passengers with maxi-taxi service Sydney. We ensure a comfortable ride for large groups. Easy, Spacious and we ensure punctual, safe, and easy intra-city commute, especially airport transfer sydney to and from hotels.",
            'link': ''
        }
    ];
    return (
